import type { RpgMapGateway } from "@/features/world/application/map/contracts/RpgMapGateway"
import type {
  RpgMapDetailViewDto,
  RpgMapDto,
...
} from "@/features/world/application/map/types"
...
export const httpRpgMapGateway: RpgMapGateway = {
  ...
  async createMarkerGroup(rpgId, mapId, payload) {
    ...
    if (!result.markerGroup)
      throw new Error("Nao foi possivel criar o grupo de marcadores.")
  ...
  async updateMarkerGroup(rpgId, mapId, groupId, payload) {
    ...
    if (!result.markerGroup)
      throw new Error("Nao foi possivel atualizar o grupo de marcadores.")
    return result.markerGroup
  },
