...
export const upsertRpgMapSchema = z.object({
  ...
  type: z.string().trim().max(60, "Tipo muito grande.").nullable().optional(),
  image: z
    .string()
    .trim()
...
export const upsertRpgMapSectionSchema = z.object({
  ...
  description: optionalTrimmedText,
  type: z.string().trim().max(60, "Tipo muito grande.").nullable().optional(),
  parentSectionId: z.string().trim().min(1).nullable().optional(),
  ...
  markers: z.array(
    z.object({
      ...
      name: z
        .string()
        .trim()
        .min(1, "Informe um nome para o marcador.")
        .max(120, "Nome muito grande."),
      location: z
        .string()
        .trim()
        .max(160, "Localizacao muito grande.")
        .nullable()
        .optional(),
      shortDescription: z
        .string()
      ...
      image: z
        ...
        .trim()
        .url("Informe uma URL de imagem valida.")
        .max(2048, "URL de imagem muito grande.")
        .nullable()
        .optional(),
      color: z
        .string()
      ...
      size: z
        .number()
        .finite()
        .min(0.5, "Tamanho muito pequeno.")
        .max(2, "Tamanho muito grande.")
        .nullable()
        .optional(),
