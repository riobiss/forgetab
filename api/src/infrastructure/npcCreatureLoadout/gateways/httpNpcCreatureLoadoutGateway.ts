...
export const httpNpcCreatureLoadoutGateway: NpcCreatureLoadoutGateway = {
  ...
  async listAvailableItems(rpgId): Promise<NpcCreatureLoadoutItemOptionDto[]> {
  ...
  async fetchAbilities(rpgId, characterId): Promise<NpcCreatureAbilitiesDataDto> {
  ...
  async listAvailableSkills(rpgId): Promise<NpcCreatureLoadoutSkillOptionDto[]> {
