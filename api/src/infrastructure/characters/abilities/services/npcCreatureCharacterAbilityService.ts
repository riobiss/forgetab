...
import type { NpcCreatureCharacterAbilityService } from "@/application/characters/abilities/ports/NpcCreatureCharacterAbilityService"
...
async function assertCanManageNpcCreatureAbility(rpgId: string, userId: string) {
...
export const npcCreatureCharacterAbilityService: NpcCreatureCharacterAbilityService = {
  async addAbility(rpgId, characterId, userId, params) {
    try {
      await assertCanManageNpcCreatureAbility(rpgId, userId)
