    ...
    <main className={styles.page}>
      <section className={styles.content}>
        ...
        <div className={styles.tabs}>
          ...
          <div
            className={`${styles.tabPanel} ${styles.mainPanel}`}
            role="tabpanel"
          >
            <div className={styles.infoGrid}>
              ...
              <div>
                <span>Criado em</span>
                <strong>
                  {data.createdAt ? formatDateInBrasilia(data.createdAt) : "-"}
                </strong>
              </div>
            </div>
          </div>
          ...
          <div
            className={`${styles.tabPanel} ${styles.rpgPanel}`}
            role="tabpanel"
          >
            {data.rpgProfiles.length > 0 ? (
                  ...
                  <details key={rpg.id} className={styles.rpgItem}>
                    ...
                    <div className={styles.rpgDetails}>
                      ...
                      <div>
                        ...
                        <strong>
                          {rpg.joinedAt
                            ? formatDateInBrasilia(rpg.joinedAt)
                            : "-"}
                        </strong>
                      </div>
                    </div>
              ...
              <div className={styles.emptyState}>
                ...
                <span>
                  Quando voce participar de uma campanha, ela aparecera aqui.
                </span>
              </div>
            )}
          </div>
