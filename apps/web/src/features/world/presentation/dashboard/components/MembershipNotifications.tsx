        ...
        >
          {isOwner ? (
            <>
              ...
              pendingCharacterRequests.length === 0 ? (
                    ...
                    <article key={request.id} className={styles.noticeCard}>
                      ...
                      <div className={styles.noticeActions}>
                        <button
                          type="button"
                          onClick={() =>
                            processCharacterRequest(request.id, "accept")
                          }
                          disabled={processingId === request.id}
                        >
                          Aprovar personagem
                        ...
                        <button
                          type="button"
                          onClick={() =>
                            processCharacterRequest(request.id, "reject")
                          }
                          disabled={processingId === request.id}
                        >
                          Rejeitar
            ...
            <>
              ...
              {!isAuthenticated ? (
                    ...
                    <article key={offer.id} className={styles.noticeCard}>
                      ...
                      <div className={styles.noticeActions}>
                        <button
                          type="button"
                          onClick={() =>
                            processCharacterRequest(offer.id, "accept")
                          }
                        ...
                        <button
                          type="button"
                          onClick={() =>
                            processCharacterRequest(offer.id, "reject")
                          }
                          disabled={processingId === offer.id}
                        >
                          Recusar
                ...
                <p>
                  Sua solicitacao foi enviada e aguarda aprovacao do mestre.
                </p>
              ) : (
