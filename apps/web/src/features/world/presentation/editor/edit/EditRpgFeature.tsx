...
export default function EditRpgFeature({
  ...
  const [isProgressionLevelsModalOpen, setIsProgressionLevelsModalOpen] =
    useState(false)
        ...
        {activeStage === "basic" ? (
          ...
          <section className={styles.advancedStage}>
            <RadixSwitchField
              ...
              label="Mapa mundi"
              description={
                state.useMundiMap ? "Ativo no RPG" : "Desativado no RPG"
              }
            ...
            <RadixSwitchField
              ...
              label="Usar raca"
              description={
                state.useRaceBonuses ? "Racas habilitadas" : "Racas desativadas"
              }
            ...
            <div className={styles.field}>
              ...
              <input
                value={state.costsEnabled ? "Ativado" : "Desativado"}
                readOnly
              />
            ...
            <AbilityCategoriesSection
              ...
              onAbilityCategoriesEnabledChange={
                state.setAbilityCategoriesEnabled
              }
            ...
            <PlayerTemplateFieldsSection
              ...
              onToggleList={() =>
                state.setShowCharacterIdentityList((prev) => !prev)
              }
            ...
            {data.identitySuccess ? (
              <p className={styles.success}>{data.identitySuccess}</p>
            ) : null}
          </section>
        ) : (
          <section className={styles.advancedStage}>
