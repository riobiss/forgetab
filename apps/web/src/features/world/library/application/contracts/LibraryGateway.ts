...
export interface LibraryGateway {
  ...
  fetchSection(
    rpgId: string,
    sectionId: string
  ): Promise<{ section: LibrarySectionDto; canManage: boolean }>
  fetchSectionBooks(
    rpgId: string,
    sectionId: string
  ): Promise<{
  ...
  fetchVisibilityOptions(rpgId: string): Promise<{
  ...
  fetchBook(
    rpgId: string,
    bookId: string
  ): Promise<{ book: LibraryBookDto; canEdit: boolean; canManage: boolean }>
  createBook(
    rpgId: string,
    sectionId: string,
