...
type SectionRenderState = {
  ...
  images: string[]
  customFields: Array<
    readonly [string, { value: string; type: CustomFieldType }]
  >
}
  ...
  return (
    <>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label="Detalhes da secao"
      >
        <section
          ref={modalRef}
          className={`${styles.modal} ${styles.sectionDetailsModal}`}
          tabIndex={-1}
        >
            ...
            <div className={styles.inlineActions}>
              {selectedSection.canEdit ? (
                <button
                  ...
                  onClick={() => onEdit(selectedSection)}
                >
                  <Pencil size={14} />
                </button>
              ) : null}
          ...
          <div className={styles.detailCard}>
            {activeImage ? (
              <div className={styles.sectionGallery}>
                ...
                {images.length > 1 ? (
                  <div
                    className={styles.sectionGalleryIndicators}
