...
import type { PendingMarker } from "@/features/world/location/presentation/types/mapMarkers"
...
export function MarkerFinalizeModal({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="Concluir marcadores"
    >
      <section ref={modalRef} className={styles.modal} tabIndex={-1}>
        ...
        <p className={styles.modalSubtle}>
          Depois de salvar, use <strong>Editar</strong> para ajustar descricao,
          imagem, tamanho, estilo e outras informacoes de cada marcador.
        </p>
