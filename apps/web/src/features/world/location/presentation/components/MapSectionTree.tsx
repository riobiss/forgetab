...
function MapTreeNode({
  ...
  if (isRoot) {
    return (
      <li className={`${styles.treeNode} ${styles.treeRootNode}`}>
        <div
          className={`${styles.treeLine} ${styles.treeRootLine} ${selectedId === node.id ? styles.treeLineActive : ""}`}
        >
          <div className={styles.rootSectionHeaderMain}>
            ...
            <button
              type="button"
              className={styles.rootSectionName}
  ...
  return (
    <li className={styles.treeNode}>
      <div
        className={`${styles.treeLine} ${selectedId === node.id ? styles.treeLineActive : ""}`}
      >
        <button
          type="button"
          className={styles.treeToggle}
