...
import type { MarkerPinStyle } from "@/features/world/location/presentation/types/mapMarkers"
...
export function MarkerEditModal({
  ...
  return (
    ...
    >
      <section
        ref={modalRef}
        className={`${styles.modal} ${styles.markerEditModal}`}
        tabIndex={-1}
      >
        ...
        <label className={styles.field}>
          ...
          <input
            ...
            value={markerSize}
            onChange={(event) =>
              onChangeSize(Number(event.currentTarget.value))
            }
          />
        ...
        <label className={styles.field}>
          ...
          <select
            value={markerPinStyle}
            onChange={(event) =>
              onChangePinStyle(event.target.value as MarkerPinStyle)
            }
          >
        ...
        <label className={styles.field}>
          ...
          <select
            ...
            onChange={(event) => onChangeLinkedSection(event.target.value)}
          >
