          ...
          <aside className={styles.sidebar}>
            ...
            {!loading && !loadingError && items.length === 0 ? (
              <p className={styles.muted}>
                Nenhum item cadastrado para este RPG.
              </p>
            ) : null}
            {!loading &&
            !loadingError &&
            ...
            visibleItems.length === 0 ? (
              <p className={styles.muted}>
                Nenhum item encontrado nos filtros atuais.
              </p>
            ) : null}
          </aside>
        </section>
          ...
          >
            ...
            <label className={styles.field}>
              ...
              <input
                ...
                value={giveQuantity}
                onChange={(event) =>
                  setGiveQuantity(Number(event.target.value))
                }
                required
              />
            </label>
            ...
            {giveSuccess ? (
              <p className={styles.feedback}>{giveSuccess}</p>
            ) : null}
            ...
            <div className={styles.formActions}>
              <IconButton
                ...
                type="submit"
                disabled={
                  giving || !selectedCharacterId || characters.length === 0
                }
                icon={<Check size={16} />}
                loading={giving}
                loadingIcon={
