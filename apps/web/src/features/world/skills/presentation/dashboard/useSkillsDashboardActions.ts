...
export function useSkillsDashboardActions(
  ...
  async function saveMeta(options?: SaveOptions) {
    ...
    try {
      ...
      const message =
        cause instanceof Error ? cause.message : "Erro ao salvar skill."
      setError(message)
      toast.error(message)
      return null
    } finally {
  ...
  async function saveLevel(options?: SaveOptions) {
    ...
    try {
      ...
      const message =
        cause instanceof Error ? cause.message : "Erro ao salvar level."
      setError(message)
      toast.error(message)
      return null
    } finally {
  ...
  async function createSkill() {
    ...
    try {
      ...
      const message =
        cause instanceof Error ? cause.message : "Erro ao criar skill."
      setError(message)
      toast.error(message)
    } finally {
      setSaving(false)
  ...
  async function createSnapshotLevel() {
    ...
    try {
      ...
      const message =
        cause instanceof Error ? cause.message : "Erro ao criar novo level."
      setError(message)
      toast.error(message)
    } finally {
      setSaving(false)
  ...
  async function saveAll() {
    const { activeSkill, selectedLevel, setSaving, setError, setSuccess } =
      params
  ...
  async function deleteSelectedLevel() {
    ...
    try {
      ...
      const message =
        cause instanceof Error ? cause.message : "Erro ao remover level."
      setError(message)
      toast.error(message)
    } finally {
      setSaving(false)
  ...
  async function deleteActiveSkill() {
    ...
    try {
      ...
      const message =
        cause instanceof Error ? cause.message : "Erro ao remover skill."
      setError(message)
      toast.error(message)
    } finally {
      setSaving(false)
