...
import {
  ...
  type CampaignParchmentDraft
} from "./CampaignParchmentModal"
    ...
    <>
      {showFloatingButton && !isCampaignEnded ? (
        <button
          ...
          onClick={() =>
            actions.setIsActionMenuOpen((currentState) => !currentState)
          }
      ...
      {actions.isActionMenuOpen ? (
        <div
          className={`${controlStyles.actionMenu} ${showFloatingButton ? "" : controlStyles.actionMenuToolbar}`}
        >
          {onBackToCampaign ? (
            <button
              type="button"
          ...
          {!isOwner && selectedCharacter ? (
            <button
              ...
              onClick={() =>
                actions.setIsStealthMode((currentState) => !currentState)
              }
...
function LocationPickerModal({
  ...
  const [selectedOption, setSelectedOption] =
    useState<CampaignLocationOption | null>(null)
  ...
  const filteredOptions = useMemo(() => {
    ...
    return actions.locationOptions.filter((option) =>
      [option.title, option.location, option.description, option.mapTitle].some(
  ...
  return (
    <div
      ...
      role="presentation"
      onClick={() => actions.setIsLocationModalOpen(false)}
    >
      <section
      ...
      >
        ...
        <div
          className={`${controlStyles.locationLayout} ${isSearchOpen ? controlStyles.locationLayoutSearchMode : ""}`}
        >
                    ...
                    filteredOptions.map((option) => (
                      ...
                      >
                        {option.image ? (
                          ...
                          <span
                            className={controlStyles.locationOptionFallback}
                          >
                            <MapPin size={18} />
                          </span>
                        )}
          ...
          {!isSearchOpen ? (
            <div className={controlStyles.locationDraftPanel}>
              ...
              <button
                ...
                disabled={
                  isBusy ||
                  actions.isUploadingLocationImage ||
                  actions.isLoadingLocationOptions
                }
              >
                {actions.isUploadingLocationImage
...
function SkillPickerModal({
  ...
  return (
    <div
      className={styles.modalBackdrop}
      role="presentation"
      onClick={() => actions.setIsSkillModalOpen(false)}
    >
      <section
      ...
      >
        ...
        {actions.isLoadingCharacterAbilities ? (
          ...
          <p className={styles.emptyState}>
            Esse personagem ainda nao tem habilidades para usar.
          </p>
        ) : (
              ...
              return (
                ...
                >
                  <div className={controlStyles.skillPickerAbilityMain}>
                    <strong className={controlStyles.skillPickerAbilityName}>
                      {abilityName}
                    </strong>
...
function ItemPickerModal({
  ...
  return (
    <div
      className={styles.modalBackdrop}
      role="presentation"
      onClick={() => actions.setIsItemModalOpen(false)}
    >
      <section
        className={controlStyles.actionModal}
        role="dialog"
      ...
      >
        ...
        {actions.isLoadingCharacterItems ? (
          ...
          <p className={styles.emptyState}>
            Esse personagem ainda nao tem itens para usar.
          </p>
        ) : (
          <div className={controlStyles.skillPickerList}>
                ...
                >
                  <div className={controlStyles.skillPickerAbilityMain}>
                    ...
                    <small className={controlStyles.skillPickerAbilityMeta}>
                      ...
                      {cardItem.rarityLabel} - X.{cardItem.quantity}
                    </small>
                  </div>
                  <div className={controlStyles.skillPickerActions}>
                    <button
...
function DiceRollModal({
  ...
  return (
    <div
      className={styles.modalBackdrop}
      role="presentation"
      onClick={actions.closeDiceModal}
    >
      <section
        className={controlStyles.actionModal}
        role="dialog"
      ...
      >
        ...
        <div className={controlStyles.diceFields}>
          {actions.diceEntries.map((entry, index) => (
            <div
              key={`dice-entry-${index}`}
              className={controlStyles.diceEntryRow}
            >
          ...
          <div className={controlStyles.dicePreview}>
            ...
            <div className={controlStyles.dicePreviewGroups}>
              {actions.dicePreviewGroups.map((group, groupIndex) => (
                <div
                  key={`preview-group-${groupIndex}`}
                  className={controlStyles.dicePreviewGroup}
                >
                              ...
                              currentGroups?.map(
                                (currentGroup, currentGroupIndex) =>
                                  currentGroupIndex === groupIndex
                                    ? {
                                        ...currentGroup,
                                        results: currentGroup.results.map(
                                          (
                                            currentResult,
                                            currentResultIndex
                                          ) =>
