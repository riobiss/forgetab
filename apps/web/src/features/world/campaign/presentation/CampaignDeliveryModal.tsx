      ...
      >
        <div className={styles.actionModalHeader}>
          <div>
            ...
            <p className={modalStyles.hint}>
              Escolha um alvo ou deixe livre para qualquer player pegar.
            </p>
          </div>
          <button
            type="button"
        ...
        <div className={modalStyles.tabs}>
          <button
            type="button"
            className={
              tab === "items" ? modalStyles.tabActive : modalStyles.tab
            }
          ...
          <button
            type="button"
            className={
              tab === "skills" ? modalStyles.tabActive : modalStyles.tab
            }
        ...
        <label className={modalStyles.field}>
          ...
          <Select
            ...
            onChange={(nextValue: MultiValue<RecipientOption>) =>
              setSelectedRecipients([...nextValue])
            }
        ...
        ) : (tab === "items" && visibleItems.length === 0) ||
            ...
            {tab === "items"
              ...
              : visibleSkills.map((skill) => (
                  ...
                  >
                    <span>
                      <strong>
                        {skill.displayName ?? humanizeSlug(skill.slug)}
                      </strong>
