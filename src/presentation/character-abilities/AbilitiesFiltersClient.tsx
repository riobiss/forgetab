...
import { removeCharacterAbilityUseCase } from "@/application/characterAbilities/use-cases/characterAbilities"
...
export default function AbilitiesFiltersClient({
  ...
  async function handleRemoveAbility() {
    ...
    try {
      ...
      setRemoveAbilityError(
        cause instanceof Error ? cause.message : "Erro de conexao ao remover habilidade.",
      )
    } finally {
