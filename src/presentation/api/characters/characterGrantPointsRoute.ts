...
import { grantCharacterPointsUseCase } from "@/application/characterProgression/use-cases/characterProgression"
...
export async function POST(request: NextRequest, context: RouteContext) {
  try {
    ...
    const payload = await grantCharacterPointsUseCase(deps, {
      characterId: id,
      userId,
      amount: body.amount,
    })
