...
import { createLibrarySection, listLibrarySections } from "@/application/library/use-cases/libraryApi"
...
export async function GET(request: NextRequest, context: RouteContext) {
  ...
  try {
    ...
    const payload = await listLibrarySections(deps, { rpgId, userId })
...
export async function POST(request: NextRequest, context: RouteContext) {
  ...
  try {
    ...
    const payload = await createLibrarySection(deps, { rpgId, userId, body })
