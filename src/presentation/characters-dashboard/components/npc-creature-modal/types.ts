...
export type NarrativeStatus = NpcCreatureNarrativeStatus
export type SecretFieldKey = NpcCreatureSecretFieldKey
export type NumericInputValue = NpcCreatureNumericInputValue
export type PickerMode = "inventory" | "abilities" | null

export type ExtraField = NpcCreatureExtraFieldDto & {
  id: string
}

export type NpcCreatureFormState = {
  name: string
...
export type NpcCreatureLoadoutState = {
  inventory: CharacterInventoryItemDto[]
  inventoryLoading: boolean
  inventoryError: string
  availableItems: NpcCreatureLoadoutItemOptionDto[]
  itemsLoading: boolean
  abilities: PurchasedAbilityViewDto[]
  abilitiesLoading: boolean
  abilitiesError: string
  availableSkills: NpcCreatureLoadoutSkillOptionDto[]
