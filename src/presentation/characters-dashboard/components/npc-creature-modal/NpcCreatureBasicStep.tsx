...
export default function NpcCreatureBasicStep({
  bootstrap,
  image,
  imageStatusText,
  selectedImageName,
      ...
      <div className={styles.modalGrid}>
        <label className={styles.modalField}>
          ...
          <div className={styles.modalUploadRow}>
            <label htmlFor="npc-creature-image" className={styles.modalUploadButton}>
              <ImagePlus size={16} />
